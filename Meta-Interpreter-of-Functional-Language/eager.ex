defmodule Eager do
    ...
    """
    @spec eval_scope(pattern_env) :: env
    ...
    @doc """
    Evaluate a list of expressions. If any expression evaluates
    to :error then the evaluation stops and an :error is returned,
    otherwise a list of the resulting structures is returned.
    """
